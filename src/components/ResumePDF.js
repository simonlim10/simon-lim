    ...
    <div className="resume-heading">
      ...
      <div>
        ...
        <p>
          ...
          Familiar with UI/UX best practices, responsive design, UI frameworks, web animation (with or without frameworks), styleguides, cross-browser compatibility, and UI testing. <br/>
          ...
          Spends time studying puzzles, and can solve a Rubik's cube in an average of 10 seconds.&nbsp;&nbsp; 
