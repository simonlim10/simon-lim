      ...
      <React.Fragment>
        ...
        <div className="container-max-width">
          ...
          <Presentation presentationName="UnPhone" 
                        ...
                        presentationDescription="An app I co-founded that gives rewards to students for locking their phones and focusing while in class. I conceptualized all the designs and the app's design from mockup to UX." 
