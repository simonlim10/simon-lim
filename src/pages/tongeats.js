...
import TongeatsAlter1 from "../images/tongeats/alternate-1.jpg"
import TongeatsAlter2 from "../images/tongeats/alternate-2.jpg"
...
class Tongeats extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    <React.Fragment>
      ...
      <div className="inner-studies-fullwidth">
        <CenterText centerHeading="Design Goal: Chinese elements, with a fun modern feel"
